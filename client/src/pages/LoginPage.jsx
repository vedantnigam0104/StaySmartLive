...
export default function LoginPage() {
  ...
  async function handleLoginSubmit(ev) {
    ev.preventDefault();
    try {
      const { data } = await axios.post('https://stay-smart-live.vercel.app/api/login', { email, password });
      setUser(data);
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      const { data } = await axios.post('https://stay-smart-live.vercel.app/api/login', userData);
