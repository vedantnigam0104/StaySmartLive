...
export default function IndexPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // Fetch places
        const placesResponse = await axios.get('https://stay-smart-live.vercel.app/api/places');
        ...
        if (user && user._id) {
          ...
          try {
            const remindersResponse = await axios.get(`https://stay-smart-live.vercel.app/api/reminders/${user._id}`);
