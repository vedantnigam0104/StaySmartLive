...
export default function PlacesFormPage() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://stay-smart-live.vercel.app/api/places/${id}`).then(response => {
      const { data } = response;
      setTitle(data.title);
  ...
  async function savePlace(ev) {
    ...
    if (id) {
      // update
      await axios.put('https://stay-smart-live.vercel.app/api/places', {
        id, ...placeData
      });
      setRedirect(true);
    } else {
      // new place
      await axios.post('https://stay-smart-live.vercel.app/api/places', placeData);
      setRedirect(true);
    }
  }
