...
export default function PhotosUploader({addedPhotos,onChange}) {
  ...
  async function addPhotoByLink(ev) {
    ev.preventDefault();
    const {data:filename} = await axios.post('https://stay-smart-live.vercel.app/api/upload-by-link', {link: photoLink});
    onChange(prev => {
  ...
  function uploadPhoto(ev) {
    ...
    axios.post('https://stay-smart-live.vercel.app/api/uploads', data, {
